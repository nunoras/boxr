...
`boxr skill install --harness claude|codex|pi|all` installs the bundled skills into each harness's user skill directory; omitting `--harness` installs into all three, and the prompt skill ships as a placeholder for now.
