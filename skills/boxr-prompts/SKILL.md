...
`boxr -i skills` ships it so the install path is real before the prompt skill lands.
...
Reinstalling through `boxr -i skills` replaces this file in place once the real skill ships.
