...
`boxr skill install --harness all` ships it so the install path is real before the prompt skill lands.
...
Reinstalling through `boxr skill install --harness all` replaces this file in place once the real skill ships.
